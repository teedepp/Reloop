    ...
    <div className="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-xl shadow-md p-6 text-white">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="bg-white bg-opacity-20 rounded-full px-3 py-1">
          <span className="text-sm font-medium">{user.ecoPoints} Points</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-2xl font-bold">{user.impact.carbonSaved.toFixed(1)} kg</p>
        </div>
        <div>
          <p className="text-sm text-white text-opacity-80">Packaging Reduced</p>
          <p className="text-2xl font-bold">{user.impact.packagingReduced} items</p>
        </div>
        <div>
          <p className="text-sm text-white text-opacity-80">Items Resold</p>
          <p className="text-2xl font-bold">{user.impact.itemsResold}</p>
        </div>
        <div>
          <p className="text-sm text-white text-opacity-80">Items Reused</p>
          <p className="text-2xl font-bold">{user.impact.itemsReused}</p>
        </div>
      </div>
    </div>
  );
